...
with tab5:
    ...
    # =========================
    # LIVE PREDICTION - USER FRIENDLY VERSION
    # =========================
    st.subheader("Live Prediction")
    st.write("Select a month and adjust only the simple climate and recent case values below.")
    ...
    if model is None:
        ...
        month_row = get_month_profile_row(selected_month_num, month_profile)

        # Current month defaults from month profile
        ...
        # -------------------------
        # STEP 2 - 3 COLUMN CLIMATE INPUTS
        # -------------------------
        ...
        # -------------------------
        # STEP 4 - BARANGAY MONTH FOR RANKING
        # -------------------------
        ...
        # -------------------------
        # STEP 5 - BUILD MODEL INPUTS AUTOMATICALLY
        # -------------------------
...
"""
            ...
            if barangay_risk_profile is not None and not barangay_risk_profile.empty:
                ...
                # If month-based seasonal rows exist, keep only selected month
